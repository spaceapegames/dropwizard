...
public class LoggingConfigurationTest {
    ...
    public void hasSyslogConfiguration(){
    	...
    	org.junit.Assert.assertThat(syslog.getSuffixPattern(), is("%date{ISO8601}-[%thread] %-5level %logger{35} - [GAMESERVICE] %msg%n"));
    	org.junit.Assert.assertThat(syslog.hasSuffixPattern(), is(true));
    }
}
